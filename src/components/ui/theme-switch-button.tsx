...
export function ThemeSwitch({ className = '' }: ThemeSwitchProps) {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`relative flex h-8 w-8 items-center justify-center rounded-full text-azimute-black dark:text-[#FAFAF7] hover:opacity-80 overflow-hidden ${className}`}
